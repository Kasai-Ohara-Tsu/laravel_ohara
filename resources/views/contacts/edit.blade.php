                ...
                <form action="{{route('contacts.update',['id'=>$contact->id])}}" method="post">
                    ...
                    <section class="text-gray-600 body-font relative ">
                        <div class="container px-5 py-12 mx-auto">
                            ...
                            <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">お問い合わせ編集</h1>
                            </div>
                            ...
                            <div class="-m-2">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="URL" id="URL" name="URL" value="{{$contact->ur}}" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                </div>
                                </div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="radio" id="gender" name="gender"  @if($gender === '男性') checked @endif value="0" class="mr-1">男性
                                    <input type="radio" id="gender" name="gender"  @if($gender === '女性') checked @endif value="1" class="mr-1">女性
                                </div>
                                </div>
                                ...
                                <div class="relative">
                                    ...
                                    <textarea id="contact" name="contact" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 h-32 text-base outline-none text-gray-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out">
                                        {{$contact->contact}}
                                    </textarea>
                                </div>
                                </div>
                                ...
                                <div class="p-2 w-full">
                                <button type="button" onclick="location.href='{{route('contacts.show',['id'=>$contact->id])}}'" class="flex mx-auto text-white bg-red-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">戻る</button>
                                </div>
                                </div>
